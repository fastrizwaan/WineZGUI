...
![](https://raw.githubusercontent.com/fastrizwaan/WineZGUI/main/screenshots/winezgui-0.82.png)
...
##### Version 0.82 (copy paste this on a terminal)

```
git clone --depth 1 --branch 0.82 https://github.com/fastrizwaan/WineZGUI.git
...
Downoad source [WineZGUI-0.82.tar.gz](https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.82.tar.gz) or use `git tag 0.82`

##### Using tar.gz

```
wget https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.82.tar.gz
tar -zxvf 0.82.tar.gz
cd WineZGUI-0.82
