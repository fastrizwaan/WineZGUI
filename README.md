...
![](https://github.com/fastrizwaan/WineZGUI/releases/download/0.86/winezgui-0.86.png)
...
##### Version 0.86 (copy paste this on a terminal)

```
git clone --depth 1 --branch 0.86 https://github.com/fastrizwaan/WineZGUI.git
...
Downoad source [WineZGUI-0.86.tar.gz](https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.86.tar.gz) or use `git tag 0.86`

##### Using tar.gz

```
wget https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.86.tar.gz
tar -zxvf 0.86.tar.gz
cd WineZGUI-0.86
