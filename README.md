...
![](https://github.com/fastrizwaan/WineZGUI/releases/download/0.87/winezgui-0.87.png)
...
##### Version 0.87 (copy paste this on a terminal)

```
git clone --depth 1 --branch 0.87 https://github.com/fastrizwaan/WineZGUI.git
...
Downoad source [WineZGUI-0.87.tar.gz](https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.87.tar.gz) or use `git tag 0.87`

##### Using tar.gz

```
wget https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.87.tar.gz
tar -zxvf 0.87.tar.gz
cd WineZGUI-0.87
