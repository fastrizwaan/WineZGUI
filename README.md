...
##### Version 0.96.0 (copy paste this on a terminal)

```
git clone --depth 1 --branch 0.96.0 https://github.com/fastrizwaan/WineZGUI.git
...
Downoad source [WineZGUI-0.96.0.tar.gz](https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.96.0.tar.gz) or use `git tag 0.96.0`

##### Using tar.gz

```
wget https://github.com/fastrizwaan/WineZGUI/archive/refs/tags/0.96.0.tar.gz
